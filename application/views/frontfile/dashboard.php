        ...
        <div class="col">
            ...
            <div class="row sidebar-sec-back-2 set-width-height">
                <div class="col-md-3 fixed">
                    ...
                    <p class="profile-text-color profile-margin-top-bottom">DIRECT MESSAGES<a href="#"><i class="fa fa-plus" style="color:#ffff; margin-left: 20px;"></i></a>
                    </p>

                    <div class="col-md-12 scroll-tab">
                        <div class="row">
                            <ul class="list-group list-group-light list-group-width" style="height: 100vh;">
                            <?php
                ...
                <div class="col-md-9 lightgray-22 ">
                    <div class="row">
                        <!-- <div class="col-md-9"> -->
                        <div class="col-md-8 set-height border border-dark margin-top">
                            ...
                            <div class="input-group">
                                <input type="search" class="form-control rounded" placeholder=" Enter a username #X0X0" aria-label="Search" aria-describedby="search-addon" />
                                <button type="button" class="btn btn-primary">Send Friend Request</button>

                            </div>
                            <div class="img">
                                <img class="logo-center" src="<?php echo base_url() . 'assets/frontfile/images/' ?>Jon_arbuckle 1.png" class="w-100">
                ...
                <div class="modal-body">
                    ...
                    <div class="main">
                        ...
                        <option value="3">Inactive</option>
                            ...
                            <a href="#myModal-3"><span class="greater-than-symbol">&#62;</span></a>
                        </div>
