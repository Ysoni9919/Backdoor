                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Ip Logs</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <h4 class="mb-sm-0 font-size-18">Ip Logs List</h4>
                                ...
                                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Email</th>
                                            <th>datetime</th>
                                            <th>type(login,register,password reset)</th>
                                            <th>Action</th>
