                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active"><?php echo 'File Details'; ?></li>
                                </ol>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <h4 class="mb-sm-0 font-size-18">User File Details</h4>
                                ...
                                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Reciver Username Or Group Name</th>
                                            <th>Total Download</th>
                                            <th>if user free or Group & Channel(free,paid)</th>
                                            <th>Total No. of Review</th>
                                            <th>Total Earning</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>Abc123</td>
                                            <td>Group name or Single username</td>
                                            <td><button type="button" class="btn btn-primary waves-effect waves-light"><i class="mdi mdi-alpha-c-circle"></i> 12</button></td>
                                            <td>if user Free else Free or Paid</td>
                                            <td>120</td>
                                            <td><button type="button" class="btn btn-success waves-effect waves-light"><i class="mdi mdi-alpha-c-circle"></i> 120</button></td>
                                            <td>12-03-2023 13:01:02</td>
                                            <td>
                                            <button type="button" class="btn btn-danger waves-effect waves-light"><i class="mdi mdi-delete"></i> Delete File</button>
                                            </td>
                                        </tr>
