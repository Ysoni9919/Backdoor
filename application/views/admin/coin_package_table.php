            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <a href="<?php echo base_url().'admin/coin_package/add'; ?>"><button type="button" class="btn btn-primary waves-effect waves-light"><i class="bx bxs-report"></i>Add New Coin Package</button></a>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <h4 class="mb-sm-0 font-size-18">Coin Package</h4>
