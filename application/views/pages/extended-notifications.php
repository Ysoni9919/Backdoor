...
<head>
    ...
    <!-- alertifyjs Css -->
    <link href="<?php echo base_url() ?>public/assets/libs/alertifyjs/build/css/alertify.min.css" rel="stylesheet" type="text/css" />

    <!-- alertifyjs default themes  Css -->
    <link href="<?php echo base_url() ?>public/assets/libs/alertifyjs/build/css/themes/default.min.css" rel="stylesheet" type="text/css" />
                                        ...
                                        <div class="p-2">
                                            ...
                                            <div class="toast fade show" role="alert" aria-live="assertive" data-bs-autohide="false" aria-atomic="true">
                                                <div class="toast-header">
                                                    <img src="<?php echo base_url() ?>public/assets/images/logo-sm.svg" alt="" class="me-2" height="18">
...
<script src="<?php echo base_url() ?>public/assets/libs/alertifyjs/build/alertify.min.js"></script>
<script src="<?php echo base_url() ?>public/assets/js/pages/notification.init.js"></script>
