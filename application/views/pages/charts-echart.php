...
<!-- echarts js -->
<script src="<?php echo base_url() ?>public/assets/libs/echarts/echarts.min.js"></script>
<!-- echarts init -->
<script src="<?php echo base_url() ?>public/assets/js/pages/echarts.init.js"></script>
