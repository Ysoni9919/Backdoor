...
<!-- Responsive Table js -->
<script src="<?php echo base_url() ?>public/assets/libs/admin-resources/rwd-table/rwd-table.min.js"></script>

<!-- Init js -->
<script src="<?php echo base_url() ?>public/assets/js/pages/table-responsive.init.js"></script>
