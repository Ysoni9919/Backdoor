...
<?php 
require_once ("./<?php echo base_url() ?>public/assets/lang/en.php");
?>
...
<head>
    ...
    <!-- Bootstrap Css -->
    <link href="<?php echo base_url() ?>public/assets/css/bootstrap-rtl.min.css" id="bootstrap-style" rel="stylesheet" type="text/css" />
    <!-- Icons Css -->
    <link href="<?php echo base_url() ?>public/assets/css/icons.min.css" rel="stylesheet" type="text/css" />
    <!-- App Css-->
    <link href="<?php echo base_url() ?>public/assets/css/app-rtl.min.css" id="app-style" rel="stylesheet" type="text/css" />
