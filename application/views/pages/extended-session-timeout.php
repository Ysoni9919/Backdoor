...
<!-- Session timeout js -->
<script src="<?php echo base_url() ?>public/assets/libs/@curiosityx/bootstrap-session-timeout/index.js"></script>

<!-- Session timeout init js -->
<script src="<?php echo base_url() ?>public/assets/js/pages/session-timeout.init.js"></script>
