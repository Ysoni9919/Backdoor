                        ...
                        <div class="email-leftbar card">
                            ...
                            <div class="mt-2">
                                <a href="javascript: void(0);" class="d-flex align-items-start">
                                    <img class="flex-shrink-0 me-3 rounded-circle" src="<?php echo base_url() ?>public/assets/images/users/avatar-2.jpg" alt="Generic placeholder image" height="36">
                                ...
                                <a href="javascript: void(0);" class="d-flex align-items-start">
                                    <img class="flex-shrink-0 me-3 rounded-circle" src="<?php echo base_url() ?>public/assets/images/users/avatar-3.jpg" alt="Generic placeholder image" height="36">
                                    <div class="flex-grow-1 chat-user-box">
                                ...
                                <a href="javascript: void(0);" class="d-flex align-items-start">
                                    <img class="flex-shrink-0 me-3 rounded-circle" src="<?php echo base_url() ?>public/assets/images/users/avatar-4.jpg" alt="Generic placeholder image" height="36">
                                    <div class="flex-grow-1 chat-user-box">
                                ...
                                <a href="javascript: void(0);" class="d-flex align-items-start">
                                    <img class="flex-shrink-0 me-3 rounded-circle" src="<?php echo base_url() ?>public/assets/images/users/avatar-6.jpg" alt="Generic placeholder image" height="36">
                                    <div class="flex-grow-1 chat-user-box">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="flex-shrink-0 me-3">
                                            <img class="rounded-circle avatar-sm" src="<?php echo base_url() ?>public/assets/images/users/avatar-2.jpg" alt="Generic placeholder image">
                                        </div>
...
<!-- email editor init -->
<script src="<?php echo base_url() ?>public/assets/js/pages/email-editor.init.js"></script>
