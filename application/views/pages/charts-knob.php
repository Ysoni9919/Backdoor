...
<!-- jquery-knob plugin  -->
<script src="<?php echo base_url() ?>public/assets/libs/jquery-knob/jquery.knob.min.js"></script>
<!-- jquery-knob init -->
<script src="<?php echo base_url() ?>public/assets/js/pages/jquery-knob.init.js"></script>
